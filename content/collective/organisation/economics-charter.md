---
title: "Economics Charter"
description: "How contributor compensation works at the Nano Collective — written down, in public, before you decide to invest your time"
sidebar_order: 2
---
...
For wider context on what the Nano Collective is and how it is structured, see the [Introduction](/collective) and the [Organisation](/collective/organisation) pages. In short: the collective is community-led, fiscally hosted by [Open Source Collective](https://opencollective.com/nano-collective), with a founding core team that stewards the work day to day. NC has no separate legal entity of its own — every incoming and outgoing payment received via OSC is published transparently on the Open Collective platform, in real time, visible to anyone.
...
1. **Identify the work.** Either pick up an existing GitHub issue tagged for bounty, or propose a piece of work to a maintainer on the project's GitHub or in [Discord](https://discord.gg/ktPDV6rekE).
2. **Agree the scope.** A maintainer confirms the work is in-scope and writes the deliverable, acceptance criteria, and bounty amount into the issue (or a linked agreement). Nothing is open-ended. Nothing is retrospective. You know what you will be paid before you start.
3. **Do the work.** Submit a PR referencing the agreed scope. Acceptance follows the project's normal review process.
4. **Get paid.** Once the work is merged and accepted, payment is processed through the Open Collective expense flow.
...
**Funding the collective** — for how to donate, sponsor, or otherwise support the Nano Collective, see [Support the Collective](/collective/organisation/support). All incoming funds received via Open Source Collective appear on the public Open Collective ledger in real time.
...
- Following the Nano Collective [Code of Conduct](/collective/organisation/community#code-of-conduct).
...
- **A platform for community-built specialist tooling** — including the financial terms (platform margin, fees, payout cadence) and a formal contributor agreement to accompany it. None of this is live yet, and the specifics will be published in this charter — with at least 30 days notice — before anything launches.
...
- **Long-term contributor coordination mechanisms** — including the possibility of token-based coordination as the community grows. We are not committing to a specific direction here, and any move in that area will be published in this charter, with at least 30 days notice, before it takes effect.
