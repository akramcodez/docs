...
**Send a short welcome.** Before day one, the point of contact sends a friendly note that covers: who is on the core team and what each person tends to own, the one or two channels to be in from day one, when the first time to meet the team is, and what the first day or two will look like. Removing the "what am I supposed to do now?" feeling on the first morning is most of the job.
